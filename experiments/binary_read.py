...
HEADER_SIZE = 3 * 32  # Taille fixe du HEADER en octets
...
def read_binary_file(file_path):
    ...
    # Extraction du TIMESTAMP START et STOP et VERSION
    ...
    # Détection du footer (64 octets de FF)
    footer_offset = measure_offset + 32

    print(f"Footer offset: {footer_offset} bytes")

    # Extraction et conversion de la configuration JSON après le footer
...
file_path = 'measures-template.bin'
