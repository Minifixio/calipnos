...
'''
source_filename = "../Data/2023_03_16_DATA.csv" # Chemin relatif vers un fichier csv à traiter
target_filename = "../2022_03_16_DATA_cleaned_data.csv" # Chemin relatif vers le fichier d'écriture

cp.process_csv(source_filename, target_filename, filter_params, 
               event_det_params, plot=True, event_detection=True)
